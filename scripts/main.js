...
function Cell(r,g,b,enable){
	...
	Cell.prototype.addColor = function(cell){

		if(cell.enable==0)return;
		this.r = parseInt((this.r + cell.r));
	//	if (this.r>255 ) this.r= 254;
		this.g = parseInt((this.g + cell.g));
//		if (this.g>255 ) this.g= 254;

		this.b = parseInt((this.b + cell.b));
	//	if (this.b>255 ) this.b= 254;
	}
	Cell.prototype.clone = function(cell){
	...
	Cell.prototype.nextCell = function (map,x,y) {
		var cnt = 0;
...
(function(){
	...
	if(randomBoolean(0.1)){
		...
		setTimeout(function(){main(cellMap);},50);
